//the state of the game size of building who turn etc
let state = {};
...
let numberOfPlayers = 1; // 0 autoplay, 1 singleplayer and 2 two player
let simulationMode = false;
let simulationImpact = {};

const blastHoleRadius = 18;

//the main canvas element and drawing context
...
function newGame() {
    //reset game state
    state = {
      phase: "aiming", //aiming, in flight and celebrating
      currentPlayer: 1,
      round: 1,
      bomb: {
        x: undefined,
...
function draw() {
    ...
    //flip coordinate upside down to start with floor
